...
var config = {
    ...
    gather_event_param:{'event':'','event_name':'','city':'','level1_page':'','level2_page':'','source':'',
...
var gather = {
    ...
    _fetchevent_item:function(item){
    	...
    	{
    		var tag = tags[i];
			var tongji = tag.getAttribute("gather");
	    ...
	    {
	    	obj.attachEvent ? obj.attachEvent('onclick',function(){b(obj)}) :
	    	obj.addEventListener('click',function(){b(obj)});
	    };
    	function b(tag)
    	{
